  ...
  return (
    <>
      ...
      <section className="home-about">
        ...
        <p>
          Browse <Link href="/news">News</Link> for the latest stories and <Link href="/blog">Blog</Link> for analysis and commentary. Registered users can comment on articles.
        </p>
      </section>
    </>
  );
